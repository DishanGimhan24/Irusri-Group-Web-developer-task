...
const ProductList = () => {
    ...
    const products = [
      ...
      { 
        ...
        name: "Gaming Chair", 
        price: "50.00", 
        description: "High-quality product that meets all standards. It is specifically designed for people who need something that can handle heavy-duty tasks without compromising on style.", 
      ...
      { 
        ...
        name: "RAM", 
        price: "45.00", 
        description: "An excellent choice for any occasion, crafted with care using the finest materials. This product is both practical and aesthetically pleasing, making it perfect for everyday use.", 
      ...
      { 
        ...
        name: "Mouse", 
        price: "30.00", 
        description: "Perfect for daily use, very reliable and practical. It has received rave reviews from customers who appreciate its affordability without compromising on quality.", 
      ...
      { 
        ...
        price: "25.00", 
        description: "Reliable and durable product for everyday tasks. Whether you need it for work or leisure, this product is designed to make your life easier and more efficient.", 
      ...
      { 
        ...
        price: "40.00", 
        description: "The best in its class, offering great value. With its unique features and superior performance, this product is a top choice for those seeking reliability and excellence.", 
      ...
      { 
        ...
        name: "Smartphone", 
        price: "70.00", 
        description: "A top-tier smartphone with the latest features, fast performance, and a sleek design. This is the go-to choice for anyone looking for cutting-edge technology.", 
      ...
      { 
        ...
        price: "15.00", 
        description: "High-quality wireless earbuds offering superior sound quality, comfort, and long battery life. Perfect for music lovers and busy professionals.", 
      ...
      { 
        ...
        price: "30.00", 
        description: "Portable Bluetooth speaker with excellent sound quality and a long battery life, designed to deliver immersive music experiences wherever you go.", 
      ...
      { 
        ...
        price: "40.00", 
        description: "A reliable external hard drive for storing large files and backups. With fast data transfer speeds and durable build quality, it's the ideal storage solution.", 
